...
def airodump():
    ...
    if opt_Choice == "1":
        os.system("gnome-terminal -e 'bash -c \"python /root/WirelessAttackLite/CrackHead_Recon.py; exec bash\"'")
        airodump()
    elif opt_Choice == "0":
        main()
    elif opt_Choice == "2":
        os.system("gnome-terminal -e 'bash -c \"python /root/WirelessAttackLite/CrackHead_Targeted.py; exec bash\"'")
        airodump()
...
def aircrack():
    os.system("gnome-terminal -e 'bash -c \"python /root/WirelessAttackLite/CrackHead_Aircrack.py; exec bash\"'")
    main()
    return
